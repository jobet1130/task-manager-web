...
const features = [
  {
    ...
    description: "Create, organize, and track tasks with our intuitive interface and powerful filtering options.",
    color: "blue"
  },
  {
    icon: (
  ...
  },
  {
    ...
    description: "Get insights into team performance and project progress with detailed analytics and reports.",
    color: "purple"
  },
  {
    icon: (
    ...
    title: "Mobile Ready",
    description: "Access your tasks anywhere with our responsive design and native mobile apps.",
    color: "indigo"
  },
  {
    icon: (
...
export const DemoFeatures: React.FC<DemoFeaturesProps> = ({ className }) => {
  return (
    <section className={cn(
      "py-16 px-4 sm:px-6 lg:px-8 bg-white",
      className
    )}>
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
            Everything You Saw in the Demo
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Explore the powerful features that make TaskFlow the preferred choice for teams worldwide.
          </p>
        </div>
